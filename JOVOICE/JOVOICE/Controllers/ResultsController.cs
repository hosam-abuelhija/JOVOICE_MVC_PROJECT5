...
namespace JOVOICE.Controllers
{
    public class ResultsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            TempData["localPercentIrbid1_1"] = localPercentage("اربد الاولى");

            TempData["localPercentIrbid2"] = localPercentage("اربد الثانية");
            TempData["localPercentIrbid2_1"] = localPercentage("اربد الثانية");

            TempData["localPercentMafraq"] = localPercentage("المفرق");
            TempData["localPercentMafraq_1"] = localPercentage("المفرق");
